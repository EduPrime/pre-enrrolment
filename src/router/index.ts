...
console.log(import.meta.env.VITE_BASE_URL);  // A variável VITE_BASE_URL
console.log(import.meta.env.VITE_DATABASE_URL);  // A variável VITE_DATABASE_URL
console.log(import.meta.env.VITE_JWT_TOKEN);  // A variável VITE_JWT_TOKEN
